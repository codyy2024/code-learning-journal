...
Basically both examples do the same thing: their screenreaders may announce "Your password must be at least 8 characters long." or "Warning! All deletions are permanent." before or after they interact with the input form (each assitive technology is different).


---

## What didn't go well
Loads of new info/terminology, and no practice somes with it.<br>
(I even fell asleep a few times tbh.)

## What did go well
Despite what didn't go well, stll manage to (I believe so - let's see) understand their usage abnd importance.

## Suggestions
Maybe can introduce some gif/simple 2-D animation of what the announcement is like for screenreaders.

[Ends 20:32 18 Oct 2025]
